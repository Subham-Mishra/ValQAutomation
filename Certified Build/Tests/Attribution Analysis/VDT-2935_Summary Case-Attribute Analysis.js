...
test
.page `https://app.powerbi.com/groups/ca77a2d0-e137-4422-93e6-fb581b1cb7a4/reports/18adb1a2-7e0e-4492-b348-a11fedc45ffd/ReportSection`
    ...
    .meta('ID','VDT-2935')
    .meta('SEVERITY','blocker')
    ('Summary Case-Scenario 2', async t => {
        await SignIn()  
        await t
        ...
        // .click(Selector('#wizbar span').withText('Upload'))
        // .click(Selector('#wizbar .storage-tree-name-input'))
        // .typeText(Selector('#wizbar .storage-tree-name-input'),'Summary Case-Scenario 2')
        // .click(Selector('#wizbar .form-icon'))
        // await doVisualRegression(t.testRun.test.testFile.currentFixture.name, t.testRun.test.name, 'Sc2_Upload')
        // await t
        // .click(Selector('#wizbar button').withText('Upload'))
        await simulate()
        await t
        ...
        .pressKey('0')
        .click(Selector('.d2VDTClose'))
        await doVisualRegression(t.testRun.test.testFile.currentFixture.name, t.testRun.test.name, 'Sc2_Simulate')
        // await t
        // .click(Selector('div.sectionContent').find('div.col-1.scenarios').find('div.nav-actions.shareScenarioIcon'))
        // .wait(3000)
        // .click(Selector('#minimodal button').withText('Share'))
        // await doVisualRegression(t.testRun.test.testFile.currentFixture.name, t.testRun.test.name, 'Sc2_Shared')
    });
    ...
    .meta('ID','VDT-2935')
    .meta('SEVERITY','blocker')
    ('Summary Case-Scenario 3', async t => {
        await SignIn()  
        await t
        ...
        // await t
        // .click(Selector('#wizbar .storage-tree-name-input'))
        // .typeText(Selector('#wizbar .storage-tree-name-input'),'Summary Case-Scenario 3')
        // .click(Selector('#wizbar .form-icon'))
        // await doVisualRegression(t.testRun.test.testFile.currentFixture.name, t.testRun.test.name, 'Sc3_Upload')
        // await t
        // .click(Selector('#wizbar button').withText('Upload'))
        await simulate()
        await t
        ...
        .pressKey('5')
        .click(Selector('.d2VDTClose'))
        await doVisualRegression(t.testRun.test.testFile.currentFixture.name, t.testRun.test.name, 'Sc3_Simulate')
        // await t
        // .click(Selector('div.sectionContent').find('div.col-1.scenarios').find('div.nav-actions.shareScenarioIcon'))
        // .wait(3000)
        // .click(Selector('#minimodal button').withText('Share'))
        // await doVisualRegression(t.testRun.test.testFile.currentFixture.name, t.testRun.test.name, 'Sc3_Shared')
    });
    ...
    .meta('ID','VDT-2935')
    .meta('SEVERITY','blocker')
    ('Summary Case-Scenario 4', async t => {
        await SignIn()  
        await t
        ...
        // .click(Selector('#wizbar span').withText('Upload'))
        // .click(Selector('#wizbar .storage-tree-name-input'))
        // .typeText(Selector('#wizbar .storage-tree-name-input'),'Summary Case-Scenario 4')
        // .click(Selector('#wizbar .form-icon'))
        // await doVisualRegression(t.testRun.test.testFile.currentFixture.name, t.testRun.test.name, 'Sc4_Upload')
        // await t
        // .click(Selector('#wizbar button').withText('Upload'))
        await simulate()
        await t
        ...
        .pressKey('0')
        .click(Selector('.d2VDTClose'))
        await doVisualRegression(t.testRun.test.testFile.currentFixture.name, t.testRun.test.name, 'Sc4_Simulate')
        // await t
        // .click(Selector('div.sectionContent').find('div.col-1.scenarios').find('div.nav-actions.shareScenarioIcon'))
        // .wait(3000)
        // .click(Selector('#minimodal button').withText('Share'))
        // await doVisualRegression(t.testRun.test.testFile.currentFixture.name, t.testRun.test.name, 'Sc4_Shared')
    });
