...
.page `https://app.powerbi.com/groups/ca77a2d0-e137-4422-93e6-fb581b1cb7a4/reports/81a390bb-2d38-47a8-8849-259c6ac5792b/ReportSection`
    .meta('ID','VDT-1595')
...
test
    ...
    .click(Selector('#sandbox-host .form-icon').nth(6))
    .click(Selector('#sandbox-host .form-icon').nth(8))
    .click(Selector('#sandbox-host .form-icon').nth(9))
    await doVisualRegression(t.testRun.test.testFile.currentFixture.name, t.testRun.test.name, 'TimeAgg-Selected')
    await t
    .click(Selector('#sandbox-host div').withText('Half Year, Half Year-to-date, Year-to-go').nth(17))
    ...
    .click(Selector('#minimodal div').withText('Half Year').nth(7))
