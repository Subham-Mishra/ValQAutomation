...
.page `https://app.powerbi.com/groups/ca77a2d0-e137-4422-93e6-fb581b1cb7a4/reports/e6c5f87a-3a6c-4fda-8beb-b1ecc99aa99b/ReportSection`
    ...
    ('Global Conditional Format-Enabled Compare Series-Sim1', async t => {
        await SignIn()  
        await t
        ...
        await doVisualRegression(t.testRun.test.testFile.currentFixture.name, t.testRun.test.name, 'Income-Sim1_1Tree')
        await table()
        await doVisualRegression(t.testRun.test.testFile.currentFixture.name, t.testRun.test.name, 'Income-Sim1_Table')
        await tree()
        await t
        .click(Selector('#N1').find('path.d2VDTNode.d2VDTFocus'))
        await doVisualRegression(t.testRun.test.testFile.currentFixture.name, t.testRun.test.name, 'Income-Sim1_DetPg')
...
.page `https://app.powerbi.com/groups/ca77a2d0-e137-4422-93e6-fb581b1cb7a4/reports/e6c5f87a-3a6c-4fda-8beb-b1ecc99aa99b/ReportSection`
    ...
    .meta('ID','VDT-3139')
    .meta('SEVERITY','blocker')
    ('Global Conditional Format-Enabled Compare Series-Sim2', async t => {
        await SignIn()  
        await t
...
.page `https://app.powerbi.com/groups/ca77a2d0-e137-4422-93e6-fb581b1cb7a4/reports/e6c5f87a-3a6c-4fda-8beb-b1ecc99aa99b/ReportSection`
    ...
    .meta('ID','VDT-3139')
    .meta('SEVERITY','blocker')
    ('Global Conditional Format-Enabled Compare Series-Sim3', async t => {
        await SignIn()  
        await t
        //.clic.wait(40000)
        await switchToMainWindow()
        ...
        await t
        .click(Selector('#N1').find('path.d2VDTNode.d2VDTFocus'))
        await doVisualRegression(t.testRun.test.testFile.currentFixture.name, t.testRun.test.name, 'Income-Sim_3DetPg')
    });
...
.page `https://app.powerbi.com/groups/ca77a2d0-e137-4422-93e6-fb581b1cb7a4/reports/e6c5f87a-3a6c-4fda-8beb-b1ecc99aa99b/ReportSection`
    ...
    .meta('ID','VDT-3139')
    .meta('SEVERITY','blocker')
    ('Global Conditional Format-Enabled Compare Series-Sim4', async t => {
        await SignIn()  
        await t
        ...
        await t
        .click(Selector('#N1').find('path.d2VDTNode.d2VDTFocus'))
        await doVisualRegression(t.testRun.test.testFile.currentFixture.name, t.testRun.test.name, 'Income-Sim_4DetPg')
    });
...
.page `https://app.powerbi.com/groups/ca77a2d0-e137-4422-93e6-fb581b1cb7a4/reports/e6c5f87a-3a6c-4fda-8beb-b1ecc99aa99b/ReportSection`
    ...
    .meta('ID','VDT-3139')
    .meta('SEVERITY','blocker')
    ('Global Conditional Format-Enabled Compare Series-Sim5', async t => {
        await SignIn()  
        await t
        //.wait(40000)
        await switchToMainWindow()
        ...
        .click(Selector('#sandbox-host span').withText('Settings'))
        .click(Selector('#sandbox-host div').withText('Conditional Formatting').nth(15))
        .click(Selector('#sandbox-host span').withText('Simulation (Sim.Primary vs Primary)'))
        await doVisualRegression(t.testRun.test.testFile.currentFixture.name, t.testRun.test.name, 'Settings-CF')
        await t
        .click(Selector('#sandbox-host button').withText('Save'))
        await model()
        ...
        .pressKey('0')
        .click(Selector('.d2VDTClose'))
        await doVisualRegression(t.testRun.test.testFile.currentFixture.name, t.testRun.test.name, 'Income-Sim_5Tree')
        await table()
        await doVisualRegression(t.testRun.test.testFile.currentFixture.name, t.testRun.test.name, 'Income-Sim_5Table')
        await tree()
        await t
        .click(Selector('#N1').find('path.d2VDTNode.d2VDTFocus'))
        await doVisualRegression(t.testRun.test.testFile.currentFixture.name, t.testRun.test.name, 'Income-Sim_5DetPg')
    });
    ...
    .page `https://app.powerbi.com/groups/ca77a2d0-e137-4422-93e6-fb581b1cb7a4/reports/e6c5f87a-3a6c-4fda-8beb-b1ecc99aa99b/ReportSection`
        ...
        .meta('ID','VDT-3139')
        .meta('SEVERITY','blocker')
        ('Global Conditional Format-Enabled Compare Series-Sim6', async t => {
            await SignIn()  
            await t
            //.wait(40000)
            await switchToMainWindow()
            ...
            .pressKey('0')
            .click(Selector('.d2VDTClose'))
            await doVisualRegression(t.testRun.test.testFile.currentFixture.name, t.testRun.test.name, 'Income-Sim_6Tree')
            await table()
            await doVisualRegression(t.testRun.test.testFile.currentFixture.name, t.testRun.test.name, 'Income-Sim_6Table')
            await tree()
            await t
            .click(Selector('#N1').find('path.d2VDTNode.d2VDTFocus'))
            await doVisualRegression(t.testRun.test.testFile.currentFixture.name, t.testRun.test.name, 'Income-Sim_6DetPg')
        });
    ...
    .page `https://app.powerbi.com/groups/ca77a2d0-e137-4422-93e6-fb581b1cb7a4/reports/e6c5f87a-3a6c-4fda-8beb-b1ecc99aa99b/ReportSection`
        ...
        .meta('ID','VDT-3139')
        .meta('SEVERITY','blocker')
        ('Global Conditional Format-Enabled Compare Series-Sim7', async t => {
            await SignIn()  
            await t
            //.wait(40000)
            await switchToMainWindow()
            ...
            .pressKey('0')
            .click(Selector('.d2VDTClose'))
            await doVisualRegression(t.testRun.test.testFile.currentFixture.name, t.testRun.test.name, 'Income-Sim_7Tree')
            await table()
            await doVisualRegression(t.testRun.test.testFile.currentFixture.name, t.testRun.test.name, 'Income-Sim_7Table')
            await tree()
            await t
            .click(Selector('#N1').find('path.d2VDTNode.d2VDTFocus'))
            await doVisualRegression(t.testRun.test.testFile.currentFixture.name, t.testRun.test.name, 'Income-Sim_7DetPg')
        });
